...
- ✅ Reveals the correct number after attempts are over  

---

## 🧠 How It Works
1. The computer randomly picks a number between 1 and 100.  
2. The player tries to guess the number within 7 attempts.  
3. For each guess:  
   - 🎉 If the guess is correct → “Correct you guessed it...”  
   - 📉 If the guess is lower → “Too low!”  
   - 📈 If the guess is higher → “Too high!”  
4. If all 7 attempts are used, the program displays the correct number.
